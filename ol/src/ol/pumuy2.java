 ...
 * @author eiron
 */
public class pumuy2 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ol/PUMA-Smash-V2-Sneaker (1).png"))); // NOI18N
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(() -> {
            ...
            frame.getContentPane().add(new pumuy2());
            frame.pack();
